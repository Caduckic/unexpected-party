...
class OldPlayer : public GameObject {
private:
    Color color;
    Vector2 vel;
...
public:
    OldPlayer(Vector2 pos, Vector2 size, Color color, float dir) : GameObject(pos, size), color{color}, vel{0, START_GRAVITY}, currentSpriteIndex{0,16}, headHitBox{pos.x,pos.y, size.x, 4},
