...
class NewPlayer : public EntityObject {
private:
    ...
    virtual void CorrectCollisionAction2(Vector2 position) override {
...
public:
    NewPlayer(Vector2 pos, Vector2 size, float dir) : EntityObject(pos, size, dir), headHitBox{pos.x,pos.y, size.x, 4}, playerNum{dir > 0 ? 1 : 2}, acceleration{PLAYER_ACCELERATION}, isJump{false}, doneLanding{true}, spriteTimer{0}, bothPressed{false}, isTakingDamage{false}, damageDir{0} {};
    ~NewPlayer() = default;
